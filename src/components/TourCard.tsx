...
const TourCard = ({ title, image, duration, price, description, itinerary }: TourCardProps) => {
    ...
    return (
        <>
            <div 
                className="bg-white rounded-card shadow-sm border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group cursor-pointer"
